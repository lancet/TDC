...
<div class="warp">
	<div class="main">
   	  	<!--文章上传内容开始-->
   	  	<div class="editor"><?php echo form_open_multipart('per_article/do');?>
            ...
            <!--编辑列表-->
            <textarea name='content'  id="content" style="height:400px;width:100%" class="xheditor {skin:'nostyle'}"></textarea>
            <!--/编辑列表-->
            	...
            	<ul>
                    ...
                    <li>
                        ...
                        <div class="ipt_textarea">
                        	<textarea name="summary" cols="" rows=""></textarea>
                  		</div>
                    </li>
                    <li class="prompt">
